...
import { navLinks, footer, contact } from "@/lib/content";

export function Footer() {
  return (
    <footer
      className="mt-auto"
      style={{ backgroundColor: "oklch(0.15 0.07 230)", color: "rgba(255,255,255,0.85)" }}
    >
      <div className="max-w-6xl mx-auto px-5 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2.5 text-sm" style={{ color: "rgba(255,255,255,0.7)" }}>
